    ...
    >
      ...
      <div style={{ flex: 1, minWidth: 0 }}>
        ...
        <div style={{ fontSize: '0.75rem', color: 'rgba(255,255,255,0.55)', lineHeight: 1.4 }}>
          Request design quotes, track your projects and contact us — all from your phone.
        </div>
      </div>

      {/* Download button */}
      <a
        href="https://royalgraphix.co.ke/app"
        target="_blank"
        ...
        style={{
          ...
          flexShrink: 0, boxShadow: '0 4px 12px rgba(200,16,46,0.45)',
